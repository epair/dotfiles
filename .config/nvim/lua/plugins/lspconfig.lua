    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Only show the most critical diagnostic on the current line (keep underline and icons in gutter)
          -- from alisnic/.dotfiles: https://github.com/alisnic/.dotfiles/blob/e5cd3f0c95132eadf0f8be09c3ce6f585ac9e921/nvim/lua/lsp.lua
          ...
          -- end config for only showing most critical diagnostic on current line
