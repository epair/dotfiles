...
Finalized PR descriptions/summaries should be output to `<parent-project>/.gitgrove/worktrees/<worktree-name-without-prefix>/pr.md`; the working directory will be a sibling directory under `<parent_project>/.`
